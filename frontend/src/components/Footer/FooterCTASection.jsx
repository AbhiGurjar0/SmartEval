...
// import { StudentInvitation } from "./Footer";
      ...
      <section className="relative overflow-hidden px-4 sm:px-6 lg:px-8 py-32">
        ...
        >
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              Powered by cutting-edge AI technology that revolutionizes how
              educators evaluate student work
            </motion.p>
          ...
          >
            ...
            <motion.div className="lg:col-span-4" variants={itemVariants}>
              ...
              <p className="text-white/60 mb-6">
                Transforming education with intelligent assessment tools
