...
const features = [
  {
    ...
    description:
      "Advanced AI algorithms for accurate plagiarism and handwriting detection",
    tag: "ACCURACY",
    highlight: true,
  ...
  },
  {
    ...
    description:
      "Enterprise-grade security with encrypted data storage and backups",
    tag: "SECURITY",
    highlight: false,
  ...
  },
  {
    ...
    description:
      "Detailed analytics and actionable feedback for student growth",
    tag: "ANALYTICS",
    highlight: true,
    ...
    <section className="relative w-full overflow-hidden bg-gradient-to-b from-gray-900 via-purple-900/10 to-gray-900 py-24 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          >
            Discover how SmartEval transforms academic evaluation with
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="relative h-full rounded-2xl border border-white/10 bg-gradient-to-br from-gray-900/50 to-gray-900/30 backdrop-blur-sm overflow-hidden transition-all duration-300">
                ...
                {/* Glow Effects */}
                <div
                  className={`absolute -top-20 -right-20 w-40 h-40 bg-gradient-to-r ${feature.gradient} rounded-full blur-3xl opacity-0 group-hover:opacity-20 transition-opacity duration-500`}
                ></div>
